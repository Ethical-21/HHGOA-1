      ...
      {currentView === 'landing' ? (
        ...
        <div className="min-h-screen flex flex-col relative z-10 bg-[#0b6637]">
          ...
          <div className="relative z-10 flex-1 flex flex-col pt-0 pb-0 min-h-screen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
                  ...
                  <div className="lg:col-span-7 xl:col-span-7 space-y-5 sm:space-y-7">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      {/* OPTION 2: PERSONALIZATION & BADGE DETAILS */}
                      {activeTab === 'personalization' && (
                        <motion.div
                          key="personalization"
                          initial={{ opacity: 0, y: 15, scale: 0.99 }}
            ...
            {/* Studio Footer (Solid Block at Bottom of Page Flow) */}
            <footer className="w-full border-t border-[#0b6637]/60 bg-[#051e10] py-4 sm:py-5 px-4 sm:px-10 text-center relative z-20">
