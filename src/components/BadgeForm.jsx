...
export default function BadgeForm({
  ...
  return (
    <div className="relative p-5 sm:p-6 bg-[#FFFBE8] border border-amber-200/90 rounded-[20px_30px_16px_34px] shadow-[6px_12px_26px_rgba(0,0,0,0.26)] space-y-4 rotate-[0.5deg] transition-transform hover:rotate-0 group overflow-hidden">
