...
export default function FrameSelector({
  ...
  return (
    <div className="relative p-5 sm:p-6 bg-[#FFFBE8] border border-amber-200/90 rounded-2xl sm:rounded-3xl shadow-[0_10px_25px_rgba(0,0,0,0.25)] space-y-4 rotate-[0.4deg] transition-transform hover:rotate-0 group">
